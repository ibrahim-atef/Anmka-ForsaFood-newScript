...
class ProfileScreen extends StatelessWidget {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    cardDecoration(themeChange, controller, "assets/icons/ic_contactus.svg", "Contact Us", () {
                                      // Get.to(const TermsAndConditionScreen(
                                      //   type: "termAndCondition",
                                      // ));
  ...
  final Uri emailLaunchUri = Uri(
    scheme: 'mailto',
    path: 'forsafeed@gmail.com',
    query: Uri.encodeFull('subject=استفسار&body=مرحباً، لدي استفسار...'),
  );
        ...
        child: Row(
          children: [
            SvgPicture.asset(
              height: 35,
              image,
              colorFilter: title == "Log In" ? const ColorFilter.mode(AppThemeData.success500, BlendMode.srcIn) : ColorFilter.mode(AppThemeData.primary300, BlendMode.srcIn),
            ),
            const SizedBox(
              width: 10,
            ),
