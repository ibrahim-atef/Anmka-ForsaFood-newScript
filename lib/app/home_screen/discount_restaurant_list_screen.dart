                                            ...
                                            child: Padding(
                                              padding:
                                                  const EdgeInsets.symmetric(
                                                      ...
                                                      vertical: 4),
                                              child: Text(
                                                "${offerModel.discountType == "Fix Price" ? "${Constant.currencyModel!.symbol}.tr" : ""}${offerModel.discount}${offerModel.discountType == "Percentage" ? "% off".toUpperCase().tr : " off".toUpperCase().tr}",
                                                textAlign: TextAlign.start,
                                                maxLines: 1,
                                                style: TextStyle(
                                                  overflow:
