                        ...
                        child: Column(
                          children: [
                            ...
                            Visibility(
                             ...
                             Visibility(
                              visible: controller.cashOnDeliverySettingModel.value.isEnabled == true,
                              child: cardDecoration(controller, PaymentGateway.fawaterak, themeChange, "assets/images/fawaterak.png"),
                            ),
                          ],
                        ),
                      ),
      ...
      () => Padding(
        ...
        child: Column(
          children: [
            InkWell(
              onTap: () {
                // print("${value.name.capitalizeString().tr} selected");
                  ...
                  value.name == "wallet"
                      ? Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                value.name.capitalizeString().tr,
                                textAlign: TextAlign.start,
                                style: TextStyle(
                                  fontFamily: AppThemeData.medium,
                                  fontSize: 16,
